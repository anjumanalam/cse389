...
// if user is logged in, put Cart and Logout options in nav bar
// If user is not logged in, only display Login button
$logout = '';
...
<body>  
    ...
    <main>
        <!-- HERO -->
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center hero-image">
            <div class="col-md-5 p-lg-5 mx-auto my-5 text-white">
                <h1 class="display-3 font-weight-normal">TASTE IT. LOVE IT. SHARE IT.</h1>
                <a class="btn btn-lg btn-outline-light mt-5" href="menu.php">ORDER NOW</a>
            </div>
            ...
            <div class="container">
                <div class="row text-center text-lg-left">
                    ...
                    <a href="#" class="d-block mb-4 h-100">
                            <img class="img-fluid img-thumbnail" src="../project-content/falafel.jpg" alt="falafel">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-4 col-6">
                    <a href="#" class="d-block mb-4 h-100">
                            <img class="img-fluid img-thumbnail" src="../project-content/burger.jpg" alt="burger">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-4 col-6">
                    <a href="#" class="d-block mb-4 h-100">
                            <img class="img-fluid img-thumbnail" src="../project-content/catering.jpg" alt="catering">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-4 col-6">
                    <a href="#" class="d-block mb-4 h-100">
                            <img class="img-fluid img-thumbnail" src="../project-content/condiments.jpg" alt="condiments">
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-4 col-6">
                    <a href="#" class="d-block mb-4 h-100">
